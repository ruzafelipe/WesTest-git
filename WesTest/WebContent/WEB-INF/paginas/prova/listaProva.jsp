...
function paginar(){
	...
	for(var x = pagAtual * qtdPorPagina; x < tamanho && x < (pagAtual+1)*qtdPorPagina;x++){
		...
		tbody.append($("<tr id='linha_"+prova.idProva+"'>")
			...
			.append($("<td>").append("<a href='agendamento_prova?id="+prova.idProva+"'><span class='glyphicon glyphicon-calendar' style='margin-left: 22px'></span></a>")));	
		}
...
<div class="row">
	...
	<a href="<c:url value="/coordenador/listar_provasFin"/>" class="btn btn-sm animated-button victoria-two" style="color:#000000;">Finalizadas</a>
	</c:if>
	...
	<a href="<c:url value="/avaliador/listar_provasFin"/>" class="btn btn-sm animated-button victoria-two" style="color:#000000;">Finalizadas</a>
	</c:if>
	</div>
</div>
	...
	<div class="form col-sm-6 col-sm-offset-3">
		...
		<table class="table table-bordered" title="PROVAS">
			...
			<thead>
				...
				<th style="width: 45px;">AGENDAR</th>
