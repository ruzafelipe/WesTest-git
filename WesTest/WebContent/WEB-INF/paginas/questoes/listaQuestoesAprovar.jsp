...
var qtdPorPagina = 10;
var pagAtual = 0;
var jsonQuestaoApovar = JSON.parse('${listaQuestoesAprovar}');
var tamanho = Object.keys(jsonQuestaoApovar).length;
var questao;

function paginar(){
	$('table > tbody > tr').remove();
	var tbody = $('table > tbody');
	tamanho = Object.keys(jsonQuestaoApovar).length;
	for(var x = pagAtual * qtdPorPagina; x < tamanho && x < (pagAtual+1)*qtdPorPagina;x++){
		questao = jsonQuestaoApovar[x];
...
<div class="row">
	<div class="form col-sm-6 col-sm-offset-3">
		<h1>Minhas Questões Pendentes</h1>
