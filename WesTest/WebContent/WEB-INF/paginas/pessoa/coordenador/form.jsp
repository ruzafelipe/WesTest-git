...
<div class="row">
	<section class="form col-sm-6 col-sm-offset-3">
		<div class="panel panel=default">
			<div class="panelheading">Cadastrando um novo coordenador...</div>
			<div class="panel-body">
				<form action="salvar_coordenador" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label>ID:</label> <input type="text"
							class="form-control input-lg" readonly="readonly" name="idPessoa"
							value="${coord.idPessoa }">
					</div>


					<div class="form-group">
						<label>Nome:</label> <input type="text" required="required"
							class="form-control input-lg" name="nome" value="${coord.nome}">
					</div>
